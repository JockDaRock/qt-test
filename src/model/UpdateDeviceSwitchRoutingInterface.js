...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MerakiDashboardApi.UpdateDeviceSwitchRoutingInterface = factory(root.MerakiDashboardApi.ApiClient, root.MerakiDashboardApi.DevicesserialswitchroutinginterfacesinterfaceIdOspfSettings);
  }
}(this, function(ApiClient, DevicesserialswitchroutinginterfacesinterfaceIdOspfSettings) {
  'use strict';

  /**
   * The UpdateDeviceSwitchRoutingInterface model module.
   * @module model/UpdateDeviceSwitchRoutingInterface
   * @version 1.1.0
   */

  /**
   * Constructs a new <code>UpdateDeviceSwitchRoutingInterface</code>.
   * @alias module:model/UpdateDeviceSwitchRoutingInterface
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdateDeviceSwitchRoutingInterface</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateDeviceSwitchRoutingInterface} obj Optional instance to populate.
   * @return {module:model/UpdateDeviceSwitchRoutingInterface} The populated <code>UpdateDeviceSwitchRoutingInterface</code> instance.
   */
   ...
   * @member {module:model/UpdateDeviceSwitchRoutingInterface.MulticastRoutingEnum} multicastRouting
   */
