...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NetworksnetworkIdappliancefirewallcellularFirewallRulesRules', function() {
      beforeEach(function() {
        instance = new MerakiDashboardApi.NetworksnetworkIdappliancefirewallcellularFirewallRulesRules();
      });

      it('should create an instance of NetworksnetworkIdappliancefirewallcellularFirewallRulesRules', function() {
        // TODO: update the code to test NetworksnetworkIdappliancefirewallcellularFirewallRulesRules
        expect(instance).to.be.a(MerakiDashboardApi.NetworksnetworkIdappliancefirewallcellularFirewallRulesRules);
      });
      ...
      it('should have the property syslogEnabled (base name: "syslogEnabled")', function() {
        // TODO: update the code to test the property syslogEnabled
        expect(instance).to.have.property('syslogEnabled');
        // expect(instance.syslogEnabled).to.be(expectedValueLiteral);
      });
