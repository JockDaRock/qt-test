...
/**
* The OrganizationsorganizationIdbrandingPoliciesHelpSettings model module.
* @module model/OrganizationsorganizationIdbrandingPoliciesHelpSettings
* @version 1.0.0
*/
export default class OrganizationsorganizationIdbrandingPoliciesHelpSettings {
    /**
    * Constructs a new <code>OrganizationsorganizationIdbrandingPoliciesHelpSettings</code>.
    ...
    * @alias module:model/OrganizationsorganizationIdbrandingPoliciesHelpSettings
    * @class
    */
    ...
    /**
    * Constructs a <code>OrganizationsorganizationIdbrandingPoliciesHelpSettings</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrganizationsorganizationIdbrandingPoliciesHelpSettings} obj Optional instance to populate.
    * @return {module:model/OrganizationsorganizationIdbrandingPoliciesHelpSettings} The populated <code>OrganizationsorganizationIdbrandingPoliciesHelpSettings</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationsorganizationIdbrandingPoliciesHelpSettings();
    ...
    * @member {module:model/OrganizationsorganizationIdbrandingPoliciesHelpSettings.HelpTabEnum} helpTab
    */
    'helpTab' = undefined;
    /**
    ...
    * @member {module:model/OrganizationsorganizationIdbrandingPoliciesHelpSettings.GetHelpSubtabEnum} getHelpSubtab
    */
    ...
    * @member {module:model/OrganizationsorganizationIdbrandingPoliciesHelpSettings.CommunitySubtabEnum} communitySubtab
    */
    ...
    * @member {module:model/OrganizationsorganizationIdbrandingPoliciesHelpSettings.CasesSubtabEnum} casesSubtab
    */
    ...
    * @member {module:model/OrganizationsorganizationIdbrandingPoliciesHelpSettings.DataProtectionRequestsSubtabEnum} dataProtectionRequestsSubtab
    */
    ...
    * @member {module:model/OrganizationsorganizationIdbrandingPoliciesHelpSettings.UniversalSearchKnowledgeBaseSearchEnum} universalSearchKnowledgeBaseSearch
    */
    ...
    * @member {module:model/OrganizationsorganizationIdbrandingPoliciesHelpSettings.NewFeaturesSubtabEnum} newFeaturesSubtab
    */
    ...
    * @member {module:model/OrganizationsorganizationIdbrandingPoliciesHelpSettings.FirewallInfoSubtabEnum} firewallInfoSubtab
    */
    ...
    * @member {module:model/OrganizationsorganizationIdbrandingPoliciesHelpSettings.ApiDocsSubtabEnum} apiDocsSubtab
    */
    ...
    * @member {module:model/OrganizationsorganizationIdbrandingPoliciesHelpSettings.HardwareReplacementsSubtabEnum} hardwareReplacementsSubtab
    */
    ...
    * @member {module:model/OrganizationsorganizationIdbrandingPoliciesHelpSettings.SmForumsEnum} smForums
    */
    'smForums' = undefined;
