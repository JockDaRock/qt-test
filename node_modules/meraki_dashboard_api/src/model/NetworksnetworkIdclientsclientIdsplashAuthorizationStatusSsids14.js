...
* @version 1.0.0
*/
export default class NetworksnetworkIdclientsclientIdsplashAuthorizationStatusSsids14 {
    /**
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NetworksnetworkIdclientsclientIdsplashAuthorizationStatusSsids14();
