...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateDeviceCellularGatewayLan', function() {
      beforeEach(function() {
        instance = new MerakiDashboardApi.UpdateDeviceCellularGatewayLan();
      });

      it('should create an instance of UpdateDeviceCellularGatewayLan', function() {
        // TODO: update the code to test UpdateDeviceCellularGatewayLan
        expect(instance).to.be.a(MerakiDashboardApi.UpdateDeviceCellularGatewayLan);
      });
