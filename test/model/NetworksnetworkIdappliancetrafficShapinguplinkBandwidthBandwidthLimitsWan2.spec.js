...
(function(root, factory) {
  ...
  describe('NetworksnetworkIdappliancetrafficShapinguplinkBandwidthBandwidthLimitsWan2', function() {
    it('should create an instance of NetworksnetworkIdappliancetrafficShapinguplinkBandwidthBandwidthLimitsWan2', function() {
      // uncomment below and update the code to test NetworksnetworkIdappliancetrafficShapinguplinkBandwidthBandwidthLimitsWan2
      //var instane = new MerakiDashboardApi.NetworksnetworkIdappliancetrafficShapinguplinkBandwidthBandwidthLimitsWan2();
