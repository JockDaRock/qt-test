...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateNetworkSwitchStack', function() {
      beforeEach(function() {
        instance = new MerakiDashboardApi.CreateNetworkSwitchStack();
      });

      it('should create an instance of CreateNetworkSwitchStack', function() {
        // TODO: update the code to test CreateNetworkSwitchStack
        expect(instance).to.be.a(MerakiDashboardApi.CreateNetworkSwitchStack);
      });
