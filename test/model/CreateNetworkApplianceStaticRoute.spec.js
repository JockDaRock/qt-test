...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateNetworkApplianceStaticRoute', function() {
      beforeEach(function() {
        instance = new MerakiDashboardApi.CreateNetworkApplianceStaticRoute();
      });

      it('should create an instance of CreateNetworkApplianceStaticRoute', function() {
        // TODO: update the code to test CreateNetworkApplianceStaticRoute
        expect(instance).to.be.a(MerakiDashboardApi.CreateNetworkApplianceStaticRoute);
      });
