...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.NetworksnetworkIdclientsprovisionPoliciesBySsid();
  });
  ...
  describe('NetworksnetworkIdclientsprovisionPoliciesBySsid', function() {
    it('should create an instance of NetworksnetworkIdclientsprovisionPoliciesBySsid', function() {
      // uncomment below and update the code to test NetworksnetworkIdclientsprovisionPoliciesBySsid
      //var instane = new MerakiDashboardApi.NetworksnetworkIdclientsprovisionPoliciesBySsid();
      //expect(instance).to.be.a(MerakiDashboardApi.NetworksnetworkIdclientsprovisionPoliciesBySsid);
    });
