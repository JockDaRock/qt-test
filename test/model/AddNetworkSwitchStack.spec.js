...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AddNetworkSwitchStack', function() {
      beforeEach(function() {
        instance = new MerakiDashboardApi.AddNetworkSwitchStack();
      });

      it('should create an instance of AddNetworkSwitchStack', function() {
        // TODO: update the code to test AddNetworkSwitchStack
        expect(instance).to.be.a(MerakiDashboardApi.AddNetworkSwitchStack);
      });
