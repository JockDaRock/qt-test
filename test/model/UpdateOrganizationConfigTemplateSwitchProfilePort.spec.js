...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateOrganizationConfigTemplateSwitchProfilePort', function() {
      beforeEach(function() {
        instance = new MerakiDashboardApi.UpdateOrganizationConfigTemplateSwitchProfilePort();
      });

      it('should create an instance of UpdateOrganizationConfigTemplateSwitchProfilePort', function() {
        // TODO: update the code to test UpdateOrganizationConfigTemplateSwitchProfilePort
        expect(instance).to.be.a(MerakiDashboardApi.UpdateOrganizationConfigTemplateSwitchProfilePort);
      });
