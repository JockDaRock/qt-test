...
(function(root, factory) {
  ...
  /**
   * The CreateNetworkGroupPolicy model module.
   * @module model/CreateNetworkGroupPolicy
   * @version 1.1.0
   */

  /**
   * Constructs a new <code>CreateNetworkGroupPolicy</code>.
   * @alias module:model/CreateNetworkGroupPolicy
   * @class
  ...
  /**
   * Constructs a <code>CreateNetworkGroupPolicy</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateNetworkGroupPolicy} obj Optional instance to populate.
   * @return {module:model/CreateNetworkGroupPolicy} The populated <code>CreateNetworkGroupPolicy</code> instance.
   */
   ...
   * @member {module:model/CreateNetworkGroupPolicy.SplashAuthSettingsEnum} splashAuthSettings
   */
