...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateOrganizationBrandingPolicy', function() {
      beforeEach(function() {
        instance = new MerakiDashboardApi.CreateOrganizationBrandingPolicy();
      });

      it('should create an instance of CreateOrganizationBrandingPolicy', function() {
        // TODO: update the code to test CreateOrganizationBrandingPolicy
        expect(instance).to.be.a(MerakiDashboardApi.CreateOrganizationBrandingPolicy);
      });
