...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateDeviceSwitchRoutingInterface', function() {
      beforeEach(function() {
        instance = new MerakiDashboardApi.CreateDeviceSwitchRoutingInterface();
      });

      it('should create an instance of CreateDeviceSwitchRoutingInterface', function() {
        // TODO: update the code to test CreateDeviceSwitchRoutingInterface
        expect(instance).to.be.a(MerakiDashboardApi.CreateDeviceSwitchRoutingInterface);
      });
