...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MerakiDashboardApi.ConnectivityApi = factory(root.MerakiDashboardApi.ApiClient);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/ConnectivityApi~getNetworkSmDeviceConnectivityCallback
     ...
     * @param {module:api/ConnectivityApi~getNetworkSmDeviceConnectivityCallback} callback The callback function, accepting three arguments: error, data, response
