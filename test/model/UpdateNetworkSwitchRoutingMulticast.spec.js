...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateNetworkSwitchRoutingMulticast', function() {
      beforeEach(function() {
        instance = new MerakiDashboardApi.UpdateNetworkSwitchRoutingMulticast();
      });

      it('should create an instance of UpdateNetworkSwitchRoutingMulticast', function() {
        // TODO: update the code to test UpdateNetworkSwitchRoutingMulticast
        expect(instance).to.be.a(MerakiDashboardApi.UpdateNetworkSwitchRoutingMulticast);
      });
