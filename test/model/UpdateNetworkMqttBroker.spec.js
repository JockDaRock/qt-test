...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateNetworkMqttBroker', function() {
      beforeEach(function() {
        instance = new MerakiDashboardApi.UpdateNetworkMqttBroker();
      });

      it('should create an instance of UpdateNetworkMqttBroker', function() {
        // TODO: update the code to test UpdateNetworkMqttBroker
        expect(instance).to.be.a(MerakiDashboardApi.UpdateNetworkMqttBroker);
      });
