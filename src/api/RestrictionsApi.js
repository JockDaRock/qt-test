...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MerakiDashboardApi.RestrictionsApi = factory(root.MerakiDashboardApi.ApiClient);
  }
   ...
   * @module api/RestrictionsApi
   * @version 1.1.0
   */

  /**
   * Constructs a new RestrictionsApi. 
   * @alias module:api/RestrictionsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/RestrictionsApi~getNetworkSmDeviceRestrictionsCallback
     ...
     * @param {module:api/RestrictionsApi~getNetworkSmDeviceRestrictionsCallback} callback The callback function, accepting three arguments: error, data, response
