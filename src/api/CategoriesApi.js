...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MerakiDashboardApi.CategoriesApi = factory(root.MerakiDashboardApi.ApiClient);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/CategoriesApi~getNetworkApplianceContentFilteringCategoriesCallback
     ...
     * @param {module:api/CategoriesApi~getNetworkApplianceContentFilteringCategoriesCallback} callback The callback function, accepting three arguments: error, data, response
