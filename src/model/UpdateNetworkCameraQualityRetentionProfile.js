...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MerakiDashboardApi.UpdateNetworkCameraQualityRetentionProfile = factory(root.MerakiDashboardApi.ApiClient, root.MerakiDashboardApi.NetworksnetworkIdcameraqualityRetentionProfilesVideoSettings);
  }
}(this, function(ApiClient, NetworksnetworkIdcameraqualityRetentionProfilesVideoSettings) {
  'use strict';

  /**
   * The UpdateNetworkCameraQualityRetentionProfile model module.
   * @module model/UpdateNetworkCameraQualityRetentionProfile
   * @version 1.1.0
   */

  /**
   * Constructs a new <code>UpdateNetworkCameraQualityRetentionProfile</code>.
   * @alias module:model/UpdateNetworkCameraQualityRetentionProfile
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdateNetworkCameraQualityRetentionProfile</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateNetworkCameraQualityRetentionProfile} obj Optional instance to populate.
   * @return {module:model/UpdateNetworkCameraQualityRetentionProfile} The populated <code>UpdateNetworkCameraQualityRetentionProfile</code> instance.
   */
