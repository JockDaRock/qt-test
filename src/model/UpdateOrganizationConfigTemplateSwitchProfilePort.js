...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MerakiDashboardApi.UpdateOrganizationConfigTemplateSwitchProfilePort = factory(root.MerakiDashboardApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The UpdateOrganizationConfigTemplateSwitchProfilePort model module.
   * @module model/UpdateOrganizationConfigTemplateSwitchProfilePort
   * @version 1.1.0
   */

  /**
   * Constructs a new <code>UpdateOrganizationConfigTemplateSwitchProfilePort</code>.
   * @alias module:model/UpdateOrganizationConfigTemplateSwitchProfilePort
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdateOrganizationConfigTemplateSwitchProfilePort</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateOrganizationConfigTemplateSwitchProfilePort} obj Optional instance to populate.
   * @return {module:model/UpdateOrganizationConfigTemplateSwitchProfilePort} The populated <code>UpdateOrganizationConfigTemplateSwitchProfilePort</code> instance.
   */
   ...
   * @member {module:model/UpdateOrganizationConfigTemplateSwitchProfilePort.TypeEnum} type
   */
   ...
   * @member {module:model/UpdateOrganizationConfigTemplateSwitchProfilePort.StpGuardEnum} stpGuard
   */
   ...
   * @member {module:model/UpdateOrganizationConfigTemplateSwitchProfilePort.UdldEnum} udld
   */
   ...
   * @member {module:model/UpdateOrganizationConfigTemplateSwitchProfilePort.AccessPolicyTypeEnum} accessPolicyType
   */
