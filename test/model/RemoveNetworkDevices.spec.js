...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RemoveNetworkDevices', function() {
      beforeEach(function() {
        instance = new MerakiDashboardApi.RemoveNetworkDevices();
      });

      it('should create an instance of RemoveNetworkDevices', function() {
        // TODO: update the code to test RemoveNetworkDevices
        expect(instance).to.be.a(MerakiDashboardApi.RemoveNetworkDevices);
      });
