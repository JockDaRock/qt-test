...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MerakiDashboardApi.CreateNetworkSwitchStackRoutingInterface = factory(root.MerakiDashboardApi.ApiClient, root.MerakiDashboardApi.DevicesserialswitchroutinginterfacesOspfSettings);
  }
}(this, function(ApiClient, DevicesserialswitchroutinginterfacesOspfSettings) {
  'use strict';

  /**
   * The CreateNetworkSwitchStackRoutingInterface model module.
   * @module model/CreateNetworkSwitchStackRoutingInterface
   * @version 1.1.0
   */

  /**
   * Constructs a new <code>CreateNetworkSwitchStackRoutingInterface</code>.
   * @alias module:model/CreateNetworkSwitchStackRoutingInterface
   * @class
   ...
   */
  var exports = function(name, subnet, interfaceIp, vlanId) {
    this.name = name;
    this.subnet = subnet;
  ...
  /**
   * Constructs a <code>CreateNetworkSwitchStackRoutingInterface</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateNetworkSwitchStackRoutingInterface} obj Optional instance to populate.
   * @return {module:model/CreateNetworkSwitchStackRoutingInterface} The populated <code>CreateNetworkSwitchStackRoutingInterface</code> instance.
   */
   ...
   * @member {module:model/CreateNetworkSwitchStackRoutingInterface.MulticastRoutingEnum} multicastRouting
   */
