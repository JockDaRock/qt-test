...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.DevicesserialcellularGatewayportForwardingRulesRules();
  });
  ...
  describe('DevicesserialcellularGatewayportForwardingRulesRules', function() {
    it('should create an instance of DevicesserialcellularGatewayportForwardingRulesRules', function() {
      // uncomment below and update the code to test DevicesserialcellularGatewayportForwardingRulesRules
      //var instane = new MerakiDashboardApi.DevicesserialcellularGatewayportForwardingRulesRules();
      //expect(instance).to.be.a(MerakiDashboardApi.DevicesserialcellularGatewayportForwardingRulesRules);
    });
