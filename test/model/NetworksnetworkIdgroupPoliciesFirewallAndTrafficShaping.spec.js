...
(function(root, factory) {
  ...
  describe('NetworksnetworkIdgroupPoliciesFirewallAndTrafficShaping', function() {
    it('should create an instance of NetworksnetworkIdgroupPoliciesFirewallAndTrafficShaping', function() {
      // uncomment below and update the code to test NetworksnetworkIdgroupPoliciesFirewallAndTrafficShaping
      //var instane = new MerakiDashboardApi.NetworksnetworkIdgroupPoliciesFirewallAndTrafficShaping();
