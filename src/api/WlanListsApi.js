...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MerakiDashboardApi.WlanListsApi = factory(root.MerakiDashboardApi.ApiClient);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/WlanListsApi~getNetworkSmDeviceWlanListsCallback
     ...
     * @param {module:api/WlanListsApi~getNetworkSmDeviceWlanListsCallback} callback The callback function, accepting three arguments: error, data, response
