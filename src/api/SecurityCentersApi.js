...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MerakiDashboardApi.SecurityCentersApi = factory(root.MerakiDashboardApi.ApiClient);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/SecurityCentersApi~getNetworkSmDeviceSecurityCentersCallback
     ...
     * @param {module:api/SecurityCentersApi~getNetworkSmDeviceSecurityCentersCallback} callback The callback function, accepting three arguments: error, data, response
