...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MerakiDashboardApi.StatsApi = factory(root.MerakiDashboardApi.ApiClient);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/StatsApi~getOrganizationApplianceVpnStatsCallback
     ...
     * @param {module:api/StatsApi~getOrganizationApplianceVpnStatsCallback} callback The callback function, accepting three arguments: error, data, response
