...
/**
* The Body136 model module.
* @module model/Body136
* @version 1.0.0
*/
export default class Body136 {
    /**
    * Constructs a new <code>Body136</code>.
    * @alias module:model/Body136
    * @class
    */
    ...
    /**
    * Constructs a <code>Body136</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/Body136} obj Optional instance to populate.
    * @return {module:model/Body136} The populated <code>Body136</code> instance.
    */
    ...
    * @member {module:model/Body136.TypeEnum} type
    */
    'type' = undefined;
    /**
    ...
    * @member {module:model/Body136.StpGuardEnum} stpGuard
    */
    'stpGuard' = undefined;
    /**
    ...
    * @member {module:model/Body136.UdldEnum} udld
    */
    'udld' = undefined;
    /**
    ...
    * @member {module:model/Body136.AccessPolicyTypeEnum} accessPolicyType
    */
