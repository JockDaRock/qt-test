...
* @version 1.0.0
*/
export default class NetworksnetworkIdwirelessssidsnumbertrafficShapingrulesRules {
    /**
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NetworksnetworkIdwirelessssidsnumbertrafficShapingrulesRules();
