...
(function(root, factory) {
  ...
  describe('NetworksnetworkIdswitchsettingsPowerExceptions', function() {
    it('should create an instance of NetworksnetworkIdswitchsettingsPowerExceptions', function() {
      // uncomment below and update the code to test NetworksnetworkIdswitchsettingsPowerExceptions
      //var instane = new MerakiDashboardApi.NetworksnetworkIdswitchsettingsPowerExceptions();
