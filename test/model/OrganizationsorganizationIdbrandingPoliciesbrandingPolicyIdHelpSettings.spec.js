...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.OrganizationsorganizationIdbrandingPoliciesbrandingPolicyIdHelpSettings();
  });
  ...
  describe('OrganizationsorganizationIdbrandingPoliciesbrandingPolicyIdHelpSettings', function() {
    it('should create an instance of OrganizationsorganizationIdbrandingPoliciesbrandingPolicyIdHelpSettings', function() {
      // uncomment below and update the code to test OrganizationsorganizationIdbrandingPoliciesbrandingPolicyIdHelpSettings
      //var instane = new MerakiDashboardApi.OrganizationsorganizationIdbrandingPoliciesbrandingPolicyIdHelpSettings();
      //expect(instance).to.be.a(MerakiDashboardApi.OrganizationsorganizationIdbrandingPoliciesbrandingPolicyIdHelpSettings);
    });
