...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateNetworkApplianceContentFiltering', function() {
      beforeEach(function() {
        instance = new MerakiDashboardApi.UpdateNetworkApplianceContentFiltering();
      });

      it('should create an instance of UpdateNetworkApplianceContentFiltering', function() {
        // TODO: update the code to test UpdateNetworkApplianceContentFiltering
        expect(instance).to.be.a(MerakiDashboardApi.UpdateNetworkApplianceContentFiltering);
      });
      ...
      it('should have the property urlCategoryListSize (base name: "urlCategoryListSize")', function() {
        // TODO: update the code to test the property urlCategoryListSize
        expect(instance).to.have.property('urlCategoryListSize');
        // expect(instance.urlCategoryListSize).to.be(expectedValueLiteral);
      });
