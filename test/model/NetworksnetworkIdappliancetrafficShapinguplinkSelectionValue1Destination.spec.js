...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NetworksnetworkIdappliancetrafficShapinguplinkSelectionValue1Destination', function() {
      beforeEach(function() {
        instance = new MerakiDashboardApi.NetworksnetworkIdappliancetrafficShapinguplinkSelectionValue1Destination();
      });

      it('should create an instance of NetworksnetworkIdappliancetrafficShapinguplinkSelectionValue1Destination', function() {
        // TODO: update the code to test NetworksnetworkIdappliancetrafficShapinguplinkSelectionValue1Destination
        expect(instance).to.be.a(MerakiDashboardApi.NetworksnetworkIdappliancetrafficShapinguplinkSelectionValue1Destination);
      });
      ...
      it('should have the property fqdn (base name: "fqdn")', function() {
        // TODO: update the code to test the property fqdn
        expect(instance).to.have.property('fqdn');
        // expect(instance.fqdn).to.be(expectedValueLiteral);
      });
