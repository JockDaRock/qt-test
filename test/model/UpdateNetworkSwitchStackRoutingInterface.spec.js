...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateNetworkSwitchStackRoutingInterface', function() {
      beforeEach(function() {
        instance = new MerakiDashboardApi.UpdateNetworkSwitchStackRoutingInterface();
      });

      it('should create an instance of UpdateNetworkSwitchStackRoutingInterface', function() {
        // TODO: update the code to test UpdateNetworkSwitchStackRoutingInterface
        expect(instance).to.be.a(MerakiDashboardApi.UpdateNetworkSwitchStackRoutingInterface);
      });
