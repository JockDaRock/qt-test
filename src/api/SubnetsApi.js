...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MerakiDashboardApi.SubnetsApi = factory(root.MerakiDashboardApi.ApiClient);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/SubnetsApi~getDeviceApplianceDhcpSubnetsCallback
     ...
     * Return the DHCP subnet information for an appliance
     * @param {String} serial 
     * @param {module:api/SubnetsApi~getDeviceApplianceDhcpSubnetsCallback} callback The callback function, accepting three arguments: error, data, response
