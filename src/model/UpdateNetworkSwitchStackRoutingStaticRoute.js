...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MerakiDashboardApi.UpdateNetworkSwitchStackRoutingStaticRoute = factory(root.MerakiDashboardApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The UpdateNetworkSwitchStackRoutingStaticRoute model module.
   * @module model/UpdateNetworkSwitchStackRoutingStaticRoute
   * @version 1.1.0
   */

  /**
   * Constructs a new <code>UpdateNetworkSwitchStackRoutingStaticRoute</code>.
   * @alias module:model/UpdateNetworkSwitchStackRoutingStaticRoute
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdateNetworkSwitchStackRoutingStaticRoute</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateNetworkSwitchStackRoutingStaticRoute} obj Optional instance to populate.
   * @return {module:model/UpdateNetworkSwitchStackRoutingStaticRoute} The populated <code>UpdateNetworkSwitchStackRoutingStaticRoute</code> instance.
   */
