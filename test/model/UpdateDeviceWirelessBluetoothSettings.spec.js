...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateDeviceWirelessBluetoothSettings', function() {
      beforeEach(function() {
        instance = new MerakiDashboardApi.UpdateDeviceWirelessBluetoothSettings();
      });

      it('should create an instance of UpdateDeviceWirelessBluetoothSettings', function() {
        // TODO: update the code to test UpdateDeviceWirelessBluetoothSettings
        expect(instance).to.be.a(MerakiDashboardApi.UpdateDeviceWirelessBluetoothSettings);
      });
