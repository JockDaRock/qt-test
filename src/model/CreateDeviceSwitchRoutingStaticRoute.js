...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MerakiDashboardApi.CreateDeviceSwitchRoutingStaticRoute = factory(root.MerakiDashboardApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CreateDeviceSwitchRoutingStaticRoute model module.
   * @module model/CreateDeviceSwitchRoutingStaticRoute
   * @version 1.1.0
   */

  /**
   * Constructs a new <code>CreateDeviceSwitchRoutingStaticRoute</code>.
   * @alias module:model/CreateDeviceSwitchRoutingStaticRoute
   * @class
  ...
  /**
   * Constructs a <code>CreateDeviceSwitchRoutingStaticRoute</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateDeviceSwitchRoutingStaticRoute} obj Optional instance to populate.
   * @return {module:model/CreateDeviceSwitchRoutingStaticRoute} The populated <code>CreateDeviceSwitchRoutingStaticRoute</code> instance.
   */
