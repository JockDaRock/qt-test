...
/**
* The DevicesserialmanagementInterfaceWan2 model module.
* @module model/DevicesserialmanagementInterfaceWan2
* @version 1.0.0
*/
export default class DevicesserialmanagementInterfaceWan2 {
    /**
    * Constructs a new <code>DevicesserialmanagementInterfaceWan2</code>.
    * WAN 2 settings (only for MX devices)
    * @alias module:model/DevicesserialmanagementInterfaceWan2
    * @class
    */
    ...
    /**
    * Constructs a <code>DevicesserialmanagementInterfaceWan2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/DevicesserialmanagementInterfaceWan2} obj Optional instance to populate.
    * @return {module:model/DevicesserialmanagementInterfaceWan2} The populated <code>DevicesserialmanagementInterfaceWan2</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DevicesserialmanagementInterfaceWan2();
    ...
    * @member {module:model/DevicesserialmanagementInterfaceWan2.WanEnabledEnum} wanEnabled
    */
