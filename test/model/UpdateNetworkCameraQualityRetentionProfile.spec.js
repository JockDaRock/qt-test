...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateNetworkCameraQualityRetentionProfile', function() {
      beforeEach(function() {
        instance = new MerakiDashboardApi.UpdateNetworkCameraQualityRetentionProfile();
      });

      it('should create an instance of UpdateNetworkCameraQualityRetentionProfile', function() {
        // TODO: update the code to test UpdateNetworkCameraQualityRetentionProfile
        expect(instance).to.be.a(MerakiDashboardApi.UpdateNetworkCameraQualityRetentionProfile);
      });
