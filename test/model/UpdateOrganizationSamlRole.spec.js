...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateOrganizationSamlRole', function() {
      beforeEach(function() {
        instance = new MerakiDashboardApi.UpdateOrganizationSamlRole();
      });

      it('should create an instance of UpdateOrganizationSamlRole', function() {
        // TODO: update the code to test UpdateOrganizationSamlRole
        expect(instance).to.be.a(MerakiDashboardApi.UpdateOrganizationSamlRole);
      });
